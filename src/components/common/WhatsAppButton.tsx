...
export function WhatsAppButton({ phone, message, size = 'sm' }: Props) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1 ${textClass} font-medium text-white bg-[#25D366] hover:bg-[#1ebe5d] active:scale-95 ${padding} rounded-lg transition-all shrink-0`}
    >
